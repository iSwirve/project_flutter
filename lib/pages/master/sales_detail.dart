...
import 'package:basicpos_v2/pages/master/sales_cru.dart';
import 'package:flutter/material.dart';
import 'package:focused_menu/focused_menu.dart';
import 'package:focused_menu/modals.dart';

class sales_detail extends StatefulWidget {
  final index;
  const sales_detail({super.key, this.index});

  @override
  State<sales_detail> createState() => _salesState();
}

class _salesState extends State<sales_detail> {
            ...
            title: Row(
              children: [
                ...
                Container(
                  ...
                  child:
                      ImageIcon(size: 36, AssetImage("assets/icons/edit.png")),
                ),
              ],
            ),
            onPressed: () {
