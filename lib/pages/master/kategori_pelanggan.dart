...
import 'package:basicpos_v2/pages/master/kategori_pelanggan_detail.dart';
import 'package:basicpos_v2/constants/urls.dart' as url;
import 'package:flutter/material.dart';

class kategori_pelanggan extends StatefulWidget {
  const kategori_pelanggan({super.key});

  @override
  State<kategori_pelanggan> createState() => _kategoripelangganState();
}

class _kategoripelangganState extends State<kategori_pelanggan> {
  var count = 0;
  getdata() async {
                ...
                child: Material(
                  ...
                  child: TextField(
                    decoration: InputDecoration(
                      ...
                      hintText: 'Nama Kategori Pelanggan',
                    ),
                  ),
                ),
              ),
                          ...
                          return GestureDetector(
                            onTap: () async {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      kategori_pelanggan_detail(index: id),
                                ),
                              );
                            },
                            child: Row(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
          onPressed: () async => {
            ...
            //   context,
            //   MaterialPageRoute(
            //     builder: (context) => kategori_pelanggan_cru(
            //       edit: false,
            //     ),
            //   ),
            // ),
