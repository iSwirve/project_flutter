...
class kategori_pelanggan_detail extends StatefulWidget {
  final index;
  const kategori_pelanggan_detail({super.key, this.index});

  @override
  State<kategori_pelanggan_detail> createState() => _kategori_pelangganState();
}

class _kategori_pelangganState extends State<kategori_pelanggan_detail> {
  int count = 0;
            ...
            title: Row(
              children: [
                ...
                Container(
                  ...
                  child:
                      ImageIcon(size: 36, AssetImage("assets/icons/trash.png")),
                ),
              ],
            ),
            onPressed: () {
